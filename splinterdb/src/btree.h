...
typedef struct btree_pack_req {
   ...
   bool32              ci_lt_ei;     // CI < EI: alloc sets max clock, skip inherit
...
void
btree_print_subtree_access_heatmap(platform_log_handle *log_handle);
...
void
btree_reset_subtree_access_heatmap(void);

void
btree_leaf_trace_open(const char *filepath);

void
btree_leaf_trace_close(void);
