...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--threads", type=int, default=2,
                   help="Bench thread count (default: 2). Higher values "
                        "increase concurrent pressure on the cache and may "
                        "trip the 'cache locked' assertion on non-NVMe "
                        "storage; raise --cache-mb in step.")
