 ...
 * treepass.h --
 *
 *     This file contains interface for the concurrent hi cache.
 */
...
/*
 * Configuration struct to setup the hi cache sub-system.
 */
...
struct treepass {
   ...
   volatile uint64  evict_interval_thre;
   volatile timestamp  last_cycle_ts;
   volatile uint32  evict_batches;
   volatile uint64  early_eviction_ei_mult_x100;
