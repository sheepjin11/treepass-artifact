...
def build_treepass(jobs: int) -> None:
    ...
    sh(["make", "-j", str(jobs)], cwd=TREEPASS_DIR, env=env)
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--db-path", default="/mnt/nvme",
                   help="Directory holding the SplinterDB data file. "
                        "Use a real NVMe mount for paper-grade timing; "
                        "any large directory works for smoke verification. "
                        "(default: /mnt/nvme)")
