...
// ------------------------------------------------------------
// gflag definitions consumed by random_mixed_bench.cpp and by this header's
...
DEFINE_string(db_path, "/mnt/nvme", "Directory holding the SplinterDB data file.");
...
DEFINE_string(trace_load_file, "", "Alias for --trace_name; if set, takes precedence for the load phase.");
...
DEFINE_string(workload_name, "C", "YCSB-style workload name: load, A, or C.");
...
// Prefix-dist (MixGraph) parameters.
